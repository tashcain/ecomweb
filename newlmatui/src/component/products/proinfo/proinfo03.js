    ...
    render() {
        return (
            ...
            <div className='infocard container'>
                    <div className='tht01 '>
                    <h2> Premium Tea </h2><br/>
                    <img src={img01} className="img-fluid choti" alt=""/><br/> <br/>
                    <h5 className="choti">Price: <strike>₹ 180/-</strike> ₹ 150/- (500 gm)</h5>
                    <Link to="buyprod/03"><Button type="primary" className="choti" onClick={this.clickHandler}>Buy Now</Button></Link>
